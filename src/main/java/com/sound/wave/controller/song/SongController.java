...
public class SongController {
  ...
  public ResponseEntity<Iterable<Song>> getSongsByCategoryName(@PathVariable("name") String name) {
    Iterable<Song> songs = iSongService.findSongsByCategoryName(name);
    if (songs != null) {
      return new ResponseEntity<>(songs, HttpStatus.OK);
    }
    return new ResponseEntity<>(HttpStatus.NOT_FOUND);
  ...
  public ResponseEntity<Iterable<Song>> getSongsBySingerName(@PathVariable("name") String name) {
    Iterable<Song> songs = iSongService.findSongsBySingerName(name);
    if (songs != null) {
      return new ResponseEntity<>(songs, HttpStatus.OK);
    }
    return new ResponseEntity<>(HttpStatus.NOT_FOUND);
